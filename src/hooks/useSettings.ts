...
function useSettingsInternal() {
  ...
  return {
    ...
    noteFilesContent: store.noteFilesContent,
    setNoteFilesContent: store.setNoteFilesContent,
    noteFilesFilenamePrefix: store.noteFilesFilenamePrefix,
    setNoteFilesFilenamePrefix: store.setNoteFilesFilenamePrefix,
    noteFilesStructure: store.noteFilesStructure,
    setNoteFilesStructure: store.setNoteFilesStructure,
